...
class ResendConfirmationDialog extends StatefulWidget {
  const ResendConfirmationDialog({super.key});

  @override
  State<ResendConfirmationDialog> createState() => _ResendConfirmationDialogState();
}

class _ResendConfirmationDialogState extends State<ResendConfirmationDialog> {
